...
PRIVATE void    tty_do_trans(TTY* tty, MESSAGE* msg);
PRIVATE void    tty_do_change(TTY* tty, MESSAGE* msg);
...
PUBLIC void task_tty()
{
	...
	while (1) {
		...
		case DEV_WRITE:
			...
			break;
        case DEV_TRANS:
            tty_do_trans(ptty, &msg);
            break;
        case DEV_CHANGE:
            tty_do_change(ptty, &msg);
            break;
		case HARD_INT:
			/**
